...
func mm512_dbsad_epu8*(a, b: M512i, imm8: int32 | uint32): M512i {.importc: "_mm512_dbsad_epu8".}

func mm512_mask_dbsad_epu8*(src: M512i, k: Mmask32, a, b: M512i, imm8: int32 | uint32): M512i {.importc: "_mm512_mask_dbsad_epu8".}

func mm512_maskz_dbsad_epu8*(k: Mmask32, a, b: M512i, imm8: int32 | uint32): M512i {.importc: "_mm512_maskz_dbsad_epu8".}
