...
let
  ...
  cpuHasAvx512vnni* = checkInstructionSets({AVX512F, AVX512VNNI})
  cpuHasAvx512bf16* = checkInstructionSets({AVX512F, AVX512BW, AVX512BF16})
  cpuHasAvx512fp16* = checkInstructionSets({AVX512F, AVX512FP16})
  ...
  cpuHasVp2intersect* = checkInstructionSets({AVX512F, AVX512VP2INTERSECT})
